...
export const WMV_SLOT_TO_SLOT_ID = {
	0: 1,   // CS_HEAD -> head
...
export const SLOT_TO_ATTACHMENT = {
...
export const get_slot_id_for_inventory_type = (inventory_type) => {
	return INVENTORY_TYPE_TO_SLOT_ID[inventory_type] ?? null;
};

export const get_slot_id_for_wmv_slot = (wmv_slot) => {
	return WMV_SLOT_TO_SLOT_ID[wmv_slot] ?? null;
};

export const get_slot_name = (slot_id) => {
	return SLOT_ID_TO_NAME[slot_id] ?? null;
};

export const get_attachment_ids_for_slot = (slot_id) => {
	return SLOT_TO_ATTACHMENT[slot_id] ?? null;
};

export const get_slot_layer = (slot_id) => {
