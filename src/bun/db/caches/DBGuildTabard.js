...
export {
	...
	is_guild_tabard as isGuildTabard,
	get_tabard_tier as getTabardTier,
	get_background_fdid as getBackgroundFDID,
	get_border_fdid as getBorderFDID,
	get_emblem_fdid as getEmblemFDID
};

export const getBackgroundColorCount = () => background_color_count;
export const getBorderStyleCount = (tier) => border_style_counts[tier] ?? 0;
export const getBorderColorCount = () => border_color_count;
export const getEmblemDesignCount = () => emblem_design_count;
export const getEmblemColorCount = () => emblem_color_count;
export const getBackgroundColors = () => background_colors;
export const getBorderColors = () => border_colors;
export const getEmblemColors = () => emblem_colors;
