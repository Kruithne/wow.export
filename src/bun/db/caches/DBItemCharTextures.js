...
import * as DBComponentTextureFileData from './DBComponentTextureFileData.js';
...
const get_textures_by_display_id = (display_id, race_id = null, gender_index = null) => {
	...
	for (const component of components) {
		...
		if (file_data_ids && file_data_ids.length > 0) {
			const best_file_data_id = DBComponentTextureFileData.getTextureForRaceGender(file_data_ids, race_id, gender_index);
			result.push({
				section: component.section,
				fileDataID: best_file_data_id
			});
		}
	}
...
export {
	...
	get_item_textures as getItemTextures,
	get_display_id as getDisplayId,
	get_textures_by_display_id as getTexturesByDisplayId,
	COMPONENT_SECTION
};
