...
function _encodeHandshakeRequest(message: HandshakeRequest, bb: ByteBuffer): void {
...
export function decodeHandshakeRequest(binary: Uint8Array): HandshakeRequest {
  return _decodeHandshakeRequest(wrapByteBuffer(binary));
}

function _decodeHandshakeRequest(bb: ByteBuffer): HandshakeRequest {
  let message: HandshakeRequest = {} as any;
...
export function encodeHandshakeResponse(message: HandshakeResponse): Uint8Array {
  let bb = popByteBuffer();
  _encodeHandshakeResponse(message, bb);
  return toUint8Array(bb);
}

function _encodeHandshakeResponse(message: HandshakeResponse, bb: ByteBuffer): void {
...
export function decodeHandshakeResponse(binary: Uint8Array): HandshakeResponse {
  return _decodeHandshakeResponse(wrapByteBuffer(binary));
}

function _decodeHandshakeResponse(bb: ByteBuffer): HandshakeResponse {
  let message: HandshakeResponse = {} as any;
...
export function encodeRegionListRequest(message: RegionListRequest): Uint8Array {
  let bb = popByteBuffer();
  _encodeRegionListRequest(message, bb);
  return toUint8Array(bb);
}

function _encodeRegionListRequest(message: RegionListRequest, bb: ByteBuffer): void {
}

export function decodeRegionListRequest(binary: Uint8Array): RegionListRequest {
  return _decodeRegionListRequest(wrapByteBuffer(binary));
}

function _decodeRegionListRequest(bb: ByteBuffer): RegionListRequest {
  let message: RegionListRequest = {} as any;
...
export interface RegionListResponse {
  regions?: CDNRegionProto[];
}

export function encodeRegionListResponse(message: RegionListResponse): Uint8Array {
  let bb = popByteBuffer();
  _encodeRegionListResponse(message, bb);
  return toUint8Array(bb);
}

function _encodeRegionListResponse(message: RegionListResponse, bb: ByteBuffer): void {
...
export function decodeRegionListResponse(binary: Uint8Array): RegionListResponse {
  return _decodeRegionListResponse(wrapByteBuffer(binary));
}

function _decodeRegionListResponse(bb: ByteBuffer): RegionListResponse {
  let message: RegionListResponse = {} as any;
...
export interface CDNRegionProto {
  id?: string;
  display_name?: string;
  patch_host_template?: string;
  ribbit_host_template?: string;
}

export function encodeCDNRegionProto(message: CDNRegionProto): Uint8Array {
  let bb = popByteBuffer();
  _encodeCDNRegionProto(message, bb);
  return toUint8Array(bb);
}

function _encodeCDNRegionProto(message: CDNRegionProto, bb: ByteBuffer): void {
...
export function decodeCDNRegionProto(binary: Uint8Array): CDNRegionProto {
  return _decodeCDNRegionProto(wrapByteBuffer(binary));
}

function _decodeCDNRegionProto(bb: ByteBuffer): CDNRegionProto {
  let message: CDNRegionProto = {} as any;
...
function _encodeIpcMessage(message: IpcMessage, bb: ByteBuffer): void {
...
function _decodeIpcMessage(bb: ByteBuffer): IpcMessage {
  let message: IpcMessage = {} as any;
