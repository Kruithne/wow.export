...
function get_executable_filename() {
	switch (process.platform) {
		case 'win32': return 'wow_export_updater.exe';
		case 'darwin':
		case 'linux': return 'wow_export_updater';
...
async function main() {
	...
	console.log(`Building updater executable for ${platform} (${runtime})...`);
	...
	try {
		...
		console.log(`✓ Updater executable built successfully: ${executable_filename}`);
	} catch (error) {
