...
4. Rename the extensions of both files from .pyc to .py.
5. If you are UPDATING the add-on, make sure to delete the __pycache__ directory found inside io_scene_wowobj.
6. Restart Blender.